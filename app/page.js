...
import { aboutUsData, testimonialsCard } from '@/utils/LandingPageData'
    ...
    <>
      ...
      <div className='mt-7 mx-auto '>
        <div className='mb-7 max-w-2xl text-center mx-auto'>
          <h2 className='md:text-5xl text-center w-full text-3xl  text-[#2B1431] font-bold'>
        ...
        <div className='flex lg:min-h-[34rem] md:min-h-[62rem] min-h-[64rem] pt-[30px] py-[30px] px-[40px] bg-[#2B1431] mb-3 rounded-[10px] mx-2'>
          <div className='min-w-full'>
            <div className=' grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[20px]'>
              {[1, 2, 3].map((id) => (
                <div
                  key={id}
                  className='bg-[#FFF8E7] rounded-[10px] shadow border border-[#E1E3E5] divide-y'
                >
                  <div className='pt-[15px] px-[25px] pb-[25px]'>
                    <div className='flex justify-end'>
                      <div
                        className={`rounded-[20px] flex justify-center items-center px-[12px] ${
                          id === 2
                      ...
                      >
                        <p
                          className={`text-[12px] leading-[28px] font-bold ${
                            id === 3
                    ...
                    <div>
                      <p className='text-[#9b1d18] text-[18px] font-semibold'>
                        {id === 1
                          ? 'Note: Price may vary according to meal type'
                          : id === 2
                          ? 'Note: Price may vary according to meal type'
                          : 'Note: Price may vary according to meal type'}
                      </p>
                  ...
                  <div className='pt-[25px] px-[25px] pb-[35px]'>
                    <div className='text-[#111827] text-[14px] font-bold space-y-1'>
                    ...
                    <div className='mt-[25px]'>
                      <SubscribeButton
                        ...
                        variant={id === 1 ? 'try' : id === 2 ? 'next' : 'pro'}
                      />
                    </div>
                  </div>
                </div>
